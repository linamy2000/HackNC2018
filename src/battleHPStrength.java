...
public class battleHPStrength {

	public battleHPStrength() {
	...
	public static void main(String[] args) {
        ...
        if (theAnswers[index] == userAnswer) {
        	System.out.println("Correct! [Character name] hit the monster for [character strength] damage.");
        	// Continue here for battle sequence!
        } else {
        	System.out.println("Incorrect! The monster has hit [character name] for [monster strength] damage.");
        }
